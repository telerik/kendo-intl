const data = {
    ...
    numbers: {
        ...
        currencies: {
            ...
            AED: {
                displayName: "дырхем ААЭ",
                "displayName-count-one": "дырхем ААЭ",
                "displayName-count-few": "дырхемы ААЭ",
                "displayName-count-many": "дырхемаў ААЭ",
                "displayName-count-other": "дырхема ААЭ",
                symbol: "AED"
            },
            AFA: {
                displayName: "AFA",
            ...
            BBD: {
                displayName: "барбадоскі долар",
                "displayName-count-one": "барбадоскі долар",
                "displayName-count-few": "барбадоскія долары",
                "displayName-count-many": "барбадоскіх долараў",
                "displayName-count-other": "барбадоскага долара",
                symbol: "BBD",
            ...
            IRR: {
                displayName: "іранскі рыал",
                "displayName-count-one": "іранскі рыал",
                "displayName-count-few": "іранскія рыалы",
            ...
            KHR: {
                displayName: "камбаджыйскі рыэль",
                "displayName-count-one": "камбаджыйскі рыэль",
                "displayName-count-few": "камбаджыйскія рыэлі",
                "displayName-count-many": "камбаджыйскіх рыэляў",
                "displayName-count-other": "камбаджыйскага рыэля",
                symbol: "KHR",
                "symbol-alt-narrow": "៛"
            },
            KMF: {
            ...
            KZT: {
                displayName: "казахстанскі тэнгэ",
                "displayName-count-one": "казахстанскі тэнгэ",
                "displayName-count-few": "казахстанскія тэнгэ",
                "displayName-count-many": "казахстанскіх тэнгэ",
                "displayName-count-other": "казахстанскага тэнгэ",
                symbol: "KZT",
                "symbol-alt-narrow": "₸"
            },
            LAK: {
            ...
            NGN: {
                displayName: "нігерыйская найра",
                "displayName-count-one": "нігерыйская найра",
                "displayName-count-few": "нігерыйскія найры",
                "displayName-count-many": "нігерыйскіх найр",
                "displayName-count-other": "нігерыйскай найры",
                symbol: "NGN",
                "symbol-alt-narrow": "₦"
            },
            NIC: {
            ...
            OMR: {
                displayName: "аманскі рыал",
                "displayName-count-one": "аманскі рыал",
                "displayName-count-few": "аманскія рыалы",
                "displayName-count-many": "аманскіх рыалаў",
                "displayName-count-other": "аманска рыала",
                symbol: "OMR"
            },
            PAB: {
            ...
            PGK: {
                displayName: "кіна",
                "displayName-count-one": "кіна",
                "displayName-count-few": "кіна",
                "displayName-count-many": "кіна",
                "displayName-count-other": "кіна",
                symbol: "PGK"
            },
            PHP: {
            ...
            QAR: {
                displayName: "катарскі рыал",
                "displayName-count-one": "катарскі рыал",
                "displayName-count-few": "катарскія рыалы",
                "displayName-count-many": "катарскіх рыалаў",
                "displayName-count-other": "катарскага рыала",
                symbol: "QAR"
            },
            RHD: {
                displayName: "RHD",
            ...
            SHP: {
                displayName: "фунт Святой Алены",
                "displayName-count-one": "фунт Святой Алены",
                "displayName-count-few": "фунты Святой Алены",
                "displayName-count-many": "фунтаў Святой Алены",
                "displayName-count-other": "фунта Святой Алены",
                symbol: "SHP",
                "symbol-alt-narrow": "£"
            },
            SIT: {
            ...
            SLL: {
                displayName: "леонэ",
                "displayName-count-one": "леонэ",
                "displayName-count-few": "леонэ",
                "displayName-count-many": "леонэ",
                "displayName-count-other": "леонэ",
                symbol: "SLL"
            },
            SOS: {
            ...
            VUV: {
                displayName: "вату",
                "displayName-count-one": "вату",
                "displayName-count-few": "вату",
                "displayName-count-many": "вату",
                "displayName-count-other": "вату",
                symbol: "VUV"
            },
            WST: {
            ...
            YER: {
                ...
                "displayName-count-one": "еменскі рыал",
                "displayName-count-few": "еменскія рыалы",
                "displayName-count-many": "еменскіх рыалаў",
                "displayName-count-other": "еменскага рыала",
                symbol: "YER"
            },
            YUD: {
                displayName: "YUD",
            ...
            ZAR: {
                displayName: "паўднёваафрыканскі ранд",
                "displayName-count-one": "паўднёваафрыканскі ранд",
                "displayName-count-few": "паўднёваафрыканскія ранды",
                "displayName-count-many": "паўднёваафрыканскіх рандаў",
                "displayName-count-other": "паўднёваафрыканскага ранда",
                symbol: "ZAR",
                "symbol-alt-narrow": "R"
            },
            ZMK: {
    ...
    calendar: {
        ...
        dateTimeFormats: {
            ...
            availableFormats: {
                ...
                MMMMd: "d MMMM",
                MMMMEd: "E, d MMMM",
                "MMMMW-count-one": "W 'тыдзень' MMM",
                "MMMMW-count-few": "W 'тыдзень' MMM",
                "MMMMW-count-many": "W 'тыдзень' MMM",
                "MMMMW-count-other": "W 'тыдзень' MMM",
                ms: "mm.ss",
                y: "y",
                yM: "M.y",
                yMd: "d.M.y",
