    ...
    numbers: {
        ...
        currencies: {
            ...
            BRC: {
                ...
                "displayName-count-other": "Бразилско крозадо"
            },
            BRE: {
                displayName: "Бразилско крузейро (1990–1993)",
                "displayName-count-other": "Бразилско крузейро (1990–1993)"
            },
            BRL: {
            ...
            BRN: {
                ...
                "displayName-count-other": "Бразилско ново крозадо"
            },
            BRR: {
                displayName: "Бразилско крузейро",
                "displayName-count-other": "Бразилско крузейро"
            },
            BSD: {
            ...
            BUK: {
                ...
                "displayName-count-other": "Бирмански киат"
            },
            BWP: {
            ...
            CLF: {
                ...
                "displayName-count-other": "Условна разчетна единица на Чили"
            },
            CLP: {
            ...
            COU: {
                ...
                "displayName-count-other": "Колумбийска единица на реалната стойност"
            },
            CRC: {
            ...
            CSD: {
                ...
                "displayName-count-other": "Стар сръбски динар"
            },
            CSK: {
            ...
            DDM: {
                ...
                "displayName-count-other": "Източногерманска марка"
            },
            DEM: {
            ...
            ECV: {
                ...
                "displayName-count-other": "Еквадорска банкова единица"
            },
            EEK: {
            ...
            GEK: {
                ...
                "displayName-count-other": "Грузински купон"
            },
            GEL: {
            ...
            GNS: {
                ...
                "displayName-count-other": "Гвинейска сили"
            },
            GQE: {
                displayName: "Екваториално гвинейско еквеле",
                "displayName-count-other": "Екваториално гвинейско еквеле"
            },
            GRD: {
            ...
            GWE: {
                ...
                "displayName-count-other": "Ескудо от Португалска Гвинея"
            },
            GWP: {
                displayName: "Гвинея-Бисау песо",
                "displayName-count-other": "Гвинея-Бисау песо"
            },
            GYD: {
            ...
            LTT: {
                ...
                "displayName-count-other": "Литовски талон"
            },
            LUF: {
            ...
            MLF: {
                ...
                "displayName-count-other": "Малийски франк"
            },
            MMK: {
            ...
            MXV: {
                ...
                "displayName-count-other": "Мексиканска конвертируема единица (UDI)"
            },
            MYR: {
            ...
            PEI: {
                ...
                "displayName-count-other": "Перуанско инти"
            },
            PEN: {
            ...
            RHD: {
                ...
                "displayName-count-other": "Родезийски долар"
            },
            ROL: {
            ...
            SLL: {
                ...
                "displayName-count-other": "сиералеонски леоне (1964 – 2022)"
            },
            SOS: {
            ...
            UYI: {
                ...
                "displayName-count-other": "Уругвайско песо (индекс на инфлацията)"
            },
            UYP: {
            ...
            XAG: {
                displayName: "Сребро",
                "displayName-count-other": "Сребро"
            },
            XAU: {
                displayName: "Злато",
                "displayName-count-other": "Злато"
            },
            XBA: {
                displayName: "Европейска съставна единица",
                "displayName-count-other": "Европейска съставна единица"
            },
            XBB: {
                displayName: "Европейска валутна единица",
                "displayName-count-other": "Европейска валутна единица"
            },
            XBC: {
                displayName: "Европейска единица по сметка (XBC)",
                "displayName-count-other": "Европейска единица по сметка (XBC)"
            },
            XBD: {
                displayName: "Европейска единица по сметка (XBD)",
                "displayName-count-other": "Европейска единица по сметка (XBD)"
            },
            XCD: {
            ...
            XCG: {
                displayName: "Карибски гулден",
                "displayName-count-one": "Карибски гулден",
                "displayName-count-other": "Карибски гулден",
                symbol: "Cg."
            },
            XDR: {
                displayName: "Специални права на тираж",
                "displayName-count-other": "Специални права на тираж"
            },
            XEU: {
                displayName: "Еку на ЕИО",
                "displayName-count-other": "Еку на ЕИО"
            },
            XFO: {
            ...
            XPD: {
                displayName: "Паладий",
                "displayName-count-other": "Паладий"
            },
            XPF: {
            ...
            XTS: {
                ...
                "displayName-count-other": "Код резервиран за целите на тестване"
            },
            XXX: {
            ...
            YUD: {
                ...
                "displayName-count-other": "Югославски твърд динар"
            },
            YUM: {
            ...
            ZWG: {
                displayName: "Зимбабвийско злато",
                "displayName-count-one": "Зимбабвийско злато",
                "displayName-count-other": "Зимбабвийско злато"
            },
            ZWL: {
